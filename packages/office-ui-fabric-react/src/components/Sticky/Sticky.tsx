...
export class Sticky extends BaseComponent<IStickyProps, IStickyState> {
  ...
  public componentDidUpdate(prevProps: IStickyProps, prevState: IStickyState): void {
    ...
    // hasStickyStateChanged is true if component has become sticky from non-sticky or vice-versa.
    // else false.
    const hasStickyStateChanged = prevState.isStickyTop !== isStickyTop || prevState.isStickyBottom !== isStickyBottom;
    if (hasStickyStateChanged) {
      if (this._activeElement) {
        this._activeElement.focus();
      }
      scrollablePane.updateStickyRefHeights();
    }
    if (hasStickyStateChanged || prevState.distanceFromTop !== distanceFromTop) {
