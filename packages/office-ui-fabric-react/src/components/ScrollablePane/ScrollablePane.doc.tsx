...
const ScrollablePaneStickyOptimizedDetailsListExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/ScrollablePane/examples/ScrollablePane.Sticky.Optimized.DetailsList.Example') as string;
...
const ScrollablePaneStickyOptimizedDetailsListExampleCodepen = require('!@uifabric/codepen-loader!office-ui-fabric-react/src/components/ScrollablePane/examples/ScrollablePane.Sticky.Optimized.DetailsList.Example') as string;
...
export const ScrollablePanePageProps: IDocPageProps = {
  ...
  examples: [
    ...
    {
      title: 'DetailsList Locked Header Optimized',
